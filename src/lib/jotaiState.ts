...
// Dark Reader state
export const hasDarkReader = atom(false);
...
export const hasReachedFirstGambleCountThreshold = atom((get) => get(gambleCount) >= 200);
